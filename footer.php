                    ...
                    <div class="col-xl-3 col-lg-5 col-md-5 col-sm-12">
                        <div class="footer-widget">
                            <a href="index.html" class="footer-logo">
                                <img src="images/gokraft-logo.png" alt="Image">
                            </a>
                            <p class="comp-desc">
                            Welcome to Gokraft Events, where we turn dreams into memorable experiences. Our passion lies in crafting
                        ...
                        <div class="footer-widget">
                            ...
                            <ul class="contact-info list-style">
                                ...
                                <li>
                                    ...
                                    <h6>Email</h6>
                                    <a href="mailto:info@gokraft.in">info@gokraft.in</a><br>                                          
